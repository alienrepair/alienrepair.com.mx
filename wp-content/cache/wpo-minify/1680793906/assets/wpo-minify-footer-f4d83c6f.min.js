...
var swiperEl=el.querySelector('.rplgsw-container'),swiperData={loop:!0,autoplay:data.speed,slidesPerView:data.count,spaceBetween:40,autoHeight:!0,nextButton:'.rplg-slider-next',prevButton:'.rplg-slider-prev',breakpoints:{500:{slidesPerView:1,spaceBetween:10},800:{slidesPerView:data.count>1?2:1,spaceBetween:20},1024:{slidesPerView:data.count,spaceBetween:30}},onTransitionEnd:function(swiper){window.rplg_blazy&&window.rplg_blazy.revalidate()}};if(data.pagin){swiperData.paginationClickable=!0;swiperData.pagination='.rplgsw-pagination'}
