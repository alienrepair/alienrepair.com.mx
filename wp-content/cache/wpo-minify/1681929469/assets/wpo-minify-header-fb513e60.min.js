...
!function(t){"use strict";"function"==typeof define&&define.amd?define(["jquery"],t):"undefined"!=typeof module&&module.exports?module.exports=t(require("jquery")):t(jQuery)}(function(t){var e=-1,o=-1,n=function(t){return parseFloat(t)||0},a=function(e){var o=1,a=t(e),i=null,r=[];return a.each(function(){var e=t(this),a=e.offset().top-n(e.css("margin-top")),s=r.length>0?r[r.length-1]:null;null===s?r.push(e):Math.floor(Math.abs(i-a))<=o?r[r.length-1]=s.add(e):r.push(e),i=a}),r},i=function(e){var o={byRow:!0,property:"height",target:null,remove:!1};return"object"==typeof e?t.extend(o,e):("boolean"==typeof e?o.byRow=e:"remove"===e&&(o.remove=!0),o)},r=t.fn.matchHeight=function(e){var o=i(e);if(o.remove){var n=this;return this.css(o.property,""),t.each(r._groups,function(t,e){e.elements=e.elements.not(n)}),this}return this.length<=1&&!o.target?this:(r._groups.push({elements:this,options:o}),r._apply(this,o),this)};r.version="0.7.2",r._groups=[],r._throttle=80,r._maintainScroll=!1,r._beforeUpdate=null,r._afterUpdate=null,r._rows=a,r._parse=n,r._parseOptions=i,r._apply=function(e,o){var s=i(o),h=t(e),l=[h],c=t(window).scrollTop(),p=t("html").outerHeight(!0),u=h.parents().filter(":hidden");return u.each(function(){var e=t(this);e.data("style-cache",e.attr("style"))}),u.css("display","block"),s.byRow&&!s.target&&(h.each(function(){var e=t(this),o=e.css("display");"inline-block"!==o&&"flex"!==o&&"inline-flex"!==o&&(o="block"),e.data("style-cache",e.attr("style")),e.css({display:o,"padding-top":"0","padding-bottom":"0","margin-top":"0","margin-bottom":"0","border-top-width":"0","border-bottom-width":"0",height:"100px",overflow:"hidden"})}),l=a(h),h.each(function(){var e=t(this);e.attr("style",e.data("style-cache")||"")})),t.each(l,function(e,o){var a=t(o),i=0;if(s.target)i=s.target.outerHeight(!1);else{if(s.byRow&&a.length<=1)return void a.css(s.property,"");a.each(function(){var e=t(this),o=e.attr("style"),n=e.css("display");"inline-block"!==n&&"flex"!==n&&"inline-flex"!==n&&(n="block");var a={display:n};a[s.property]="",e.css(a),e.outerHeight(!1)>i&&(i=e.outerHeight(!1)),o?e.attr("style",o):e.css("display","")})}a.each(function(){var e=t(this),o=0;s.target&&e.is(s.target)||("border-box"!==e.css("box-sizing")&&(o+=n(e.css("border-top-width"))+n(e.css("border-bottom-width")),o+=n(e.css("padding-top"))+n(e.css("padding-bottom"))),e.css(s.property,i-o+"px"))})}),u.each(function(){var e=t(this);e.attr("style",e.data("style-cache")||null)}),r._maintainScroll&&t(window).scrollTop(c/p*t("html").outerHeight(!0)),this},r._applyDataApi=function(){var e={};t("[data-match-height], [data-mh]").each(function(){var o=t(this),n=o.attr("data-mh")||o.attr("data-match-height");n in e?e[n]=e[n].add(o):e[n]=o}),t.each(e,function(){this.matchHeight(!0)})};var s=function(e){r._beforeUpdate&&r._beforeUpdate(e,r._groups),t.each(r._groups,function(){r._apply(this.elements,this.options)}),r._afterUpdate&&r._afterUpdate(e,r._groups)};r._update=function(n,a){if(a&&"resize"===a.type){var i=t(window).width();if(i===e)return;e=i}n?o===-1&&(o=setTimeout(function(){s(a),o=-1},r._throttle)):s(a)},t(r._applyDataApi);var h=t.fn.on?"on":"bind";t(window)[h]("load",function(t){r._update(!1,t)}),t(window)[h]("resize orientationchange",function(t){r._update(!0,t)})});
jQuery(document).ready(function($){function dit(){this.deviceTypes=function(){var me=this;$('.dit-container').fadeOut(500,function(){$('.dit-container').empty();tool.fillWithStandardContent(me.jsonObject.device_types);$.each($('.dit-product-container'),function(){$(this).click(function(){tool.devices($(this).attr('id'))})});ditContainerFadeIn()})};this.devices=function(deviceType){var me=this;if(deviceType){tool.currentDeviceType=$.grep(me.jsonObject.device_types,function(e){return e.id===parseInt(deviceType)})[0]}
$('.dit-container').fadeOut(500,function(){$('.dit-container').empty();tool.fillWithStandardContent(tool.currentDeviceType.children_types);$.each($('.dit-product-container'),function(){$(this).click(function(){tool.deviceProblems($(this).attr('id'))})});$('.dit-device-type .name').html(tool.currentDeviceType.name);$('.dit-device-type').removeClass('hidden');ditContainerFadeIn()})};this.deviceProblems=function(device){var me=this;if(device){this.currentDeviceType.children_types=$.map(me.currentDeviceType.children_types,function(value,index){return[value]});tool.currentDevice=$.grep(this.currentDeviceType.children_types,function(e){return e.id===parseInt(device)})[0]}
$('.dit-container').fadeOut(500,function(){$('.dit-container').empty();tool.fillWithLinkedContent(tool.currentDevice.device_problems);$.each($('.dit-product-container'),function(){$(this).click(function(){tool.openForm($(this).data('id'))})});$('.dit-device .name').html(tool.currentDevice.name);$('.dit-device').removeClass('hidden');ditContainerFadeIn()})};this.fillWithStandardContent=function(typesCollection){$.each(typesCollection,function(index,value){tool.addStandardTile(value)});matchHeight($('.dit-product-container'))};this.fillWithLinkedContent=function(typesCollection){$.each(typesCollection,function(index,value){tool.addTextTile(value)});matchHeight($('.dit-product-container'))};this.addStandardTile=function(data){var html='<div class="dit-product-container"';if(data.hasOwnProperty('id')){html+=' id="'+data.id+'"'}
html+='>';html+='<div class="inner-container">';if(data.hasOwnProperty('image')){if(data.image.hasOwnProperty('path')){html+='<img src="'+data.image.path+'">'}}
if(data.hasOwnProperty('name')){html+='<p>'+data.name+'</p>'}
html+='</div>';html+='</div>';$('.dit-container').append(html)};this.addTextTile=function(data){if(!data.hasOwnProperty('device_problem')){return}
var problem=data.device_problem;var html='<div class="dit-product-container text-tile" data-id="'+problem.id+'">';html+='<div class="inner-container">';if(problem.hasOwnProperty('name')){html+='<p>'+problem.name+'</p>'}
html+='</div>';html+='</div>';$('.dit-container').append(html)};this.openForm=function(id){if(!this.currentDevice||!this.currentDevice.device_problems){return}
this.currentProblem=$.grep(this.currentDevice.device_problems,function(e){return e.device_problem.id===parseInt(id)})[0];this.currentProblem=this.currentProblem.device_problem;$('form #device_type').val(this.currentDeviceType.id);$('form #device').val(this.currentDevice.id);$('form #problem').val(this.currentProblem.id);$('.dit-container').fadeOut(400,function(){$('.form-container').fadeIn(400)});$('.dit-problem .name').html(tool.currentProblem.name);$('.dit-problem').removeClass('hidden')};$('#requestEstimateForm #submit').click(function(e){e.preventDefault();e.stopPropagation();$('#selectOneContactMethod').hide();var store=$('form #store').val();if(!store){return}
var url='https://'+store+'.computerrepairdoctor.com/api/quotequeues';var username='quote_queue';var password='eZ4JwPHwd4TKs';var authorizationToken='Basic '+(btoa(username+':'+password));if(!$('[name=contact_method]:checked').length){$('#selectOneContactMethod').show();return}
$.ajax({type:'POST',url:url,headers:{'Authorization':authorizationToken},data:$('#requestEstimateForm').serialize(),success:function(data){console.log(data)}})});this.init=function(data){tool.jsonObject=JSON.parse(data);$('.dit-loading').fadeOut(400);tool.deviceTypes();$('.dit-home').click(function(){$('.dit-device-type .name').empty();$('.dit-device-type').addClass('hidden');$('.dit-device .name').empty();$('.dit-device').addClass('hidden');$('.dit-problem .name').empty();$('.dit-problem').addClass('hidden');tool.deviceTypes()});$('.dit-device-type').click(function(){$('.dit-device .name').empty();$('.dit-device').addClass('hidden');$('.dit-problem .name').empty();$('.dit-problem').addClass('hidden');tool.devices()})};this.jsonObject;this.currentDeviceType;this.currentDevice;this.currentProblem;this.locationPageLink}
var tool=new dit();var ajaxFunctionParms={action:'get_dit_data'};$.post(ajax_options.admin_ajax_url,ajaxFunctionParms,function(response){tool.init(response);var ajaxFunctionParms={action:'get_locations_page_link',};$.post(ajax_options.admin_ajax_url,ajaxFunctionParms,function(response){tool.locationPageLink=response})});$(window).resize(function(){matchHeight('.dit-product-container')});function matchHeight(item){var options={byRow:!1,property:'height',target:null,remove:!1};setTimeout(function(){$(item).matchHeight(options)},20)}
function ditContainerFadeIn(){$('.dit-container').fadeIn(500)}});
